function [analysis] = panther(analysis) 
    ...
    parfor (i = 1 : n_members, matlab_workers)
        ...
        stress_change{i} = stress_change{i}.calc_stress_changes( ...
            ensemble_members{i}, y, analysis.dx, ...
            pressure{i}.get_dP_HW(), pressure{i}.get_dP_FW(), ...
            temperature{i}.get_dT_HW(), temperature{i}.get_dT_FW(), ...
            load_case);
